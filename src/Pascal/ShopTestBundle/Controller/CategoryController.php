...
use Pascal\ShopTestBundle\Entity\Category;
use Pascal\ShopTestBundle\Form\CategoryType;
...
class CategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PascalShopTestBundle:Category')->findAll();
     ...
     * @Method("POST")
     * @Template("PascalShopTestBundle:Category:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PascalShopTestBundle:Category:edit.html.twig")
     */
