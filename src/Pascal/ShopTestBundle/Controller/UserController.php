...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PascalShopTestBundle:User')->findAll();
     ...
     * @Method("POST")
     * @Template("PascalShopTestBundle:User:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PascalShopTestBundle:User:edit.html.twig")
     */
